...
CREATE TABLE `tirage` (
  ...
  `id_photo_t` int NOT NULL,
  `format_impr` varchar(45) DEFAULT NULL,
  `qualite_papier` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`ID`),
  UNIQUE KEY `ID_UNIQUE` (`ID`),
  KEY `id_photo_t_idx` (`id_photo_t`),
  CONSTRAINT `id_photo_t` FOREIGN KEY (`id_photo_t`) REFERENCES `photo` (`ID`)
